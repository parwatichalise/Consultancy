    ...
    <div class="container overview-section">
        <div class="row g-4">
            ...
            <div class="col-md-8">
                ...
                <p>
                    Gmat stands for “Test of English as a Foreign Language.” The Academic Version is intended for those who want to enroll in universities and other institutions of higher education and for professionals such as medical professionals and nurses who want to study or practice.
                </p>
                <p>
                ...
                <p>
                    Gmat is accepted by almost all Australian, British, Canadian, Irish, New Zealand, and more than 1800 US academic institutions. It is the only acceptable English test for immigration to Australia and also accepted by the UK and Canada.
                </p>
                

                <div class="gre-section p-4 mt-4" style="background-color: #ffffff;">
                    <h2 style="font-weight: bold; margin-bottom: 1rem;">It Doesnot Measure</h2>
                    
                    <p style="line-height: 1.6; color: #333;">
                        The gre Reasoning Test is three hours and 45 minutes long and measures skills in three areas: critical reading, math, and writing. Although most questions are multiple choice, students are also required to write a 25-minute essay. The gre assesses the critical thinking skills students need for academic success in college – skills that students learned in high school.
                    </p>
            ...
            <div class="col-md-4">
                <div class="price-section" style="background: linear-gradient(180deg, #E8F2FC, #D9EAFB); padding: 2rem; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    <h2 style="font-weight: bold;">Gmat Course</h2>
                    ...
                    <hr class="my-4">
                    <h5>gmat Test Detail in Nepal</h5>
                    <br>
                    <h6>gmat Academic Test</h6>
                    <h5>USD $165.00</h5>
            ...
            <div class="col-md-8">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem; padding: 3rem; background-color: #f9f9f9;">
                    ...
                    <div style="background-color:  linear-gradient(180deg, #E8F2FC, #D9EAFB); box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border-radius: 8px; padding: 2rem;">
                        <h3 style="font-weight: bold; margin-bottom: 1.5rem; font-size: 1.25rem;">FORMAT AND TIMING</h3>
                        <p style="line-height: 1.6; margin-bottom: 1.5rem; font-size: 0.95rem; color: #333;">
                            GMAT tests all four language skills – listening, reading, writing, and speaking. The Speaking test is a face-to-face interview with a certified Examiner. It is interactive and as close to a real-life situation as a test can get. Research shows that GMAT motivates test-takers to develop real and well-rounded English rather than learning by rote.
                        </p>
                    </div>
    
                    <!-- gmat Section -->
                    <div style="background-color: linear-gradient(180deg, #E8F2FC, #D9EAFB) ; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border-radius: 8px; padding: 2rem;">
                        <h3 style="font-weight: bold; margin-bottom: 1.5rem; font-size: 1.25rem;">ANALYTICAL</h3>
                        <p style="line-height: 1.6; margin-bottom: 1.5rem; font-size: 0.95rem; color: #333;">
                            More than 8,500 colleges, universities, and agencies in more than 130 countries rely on gmat® test scores to help make admissions decisions. You can take the gmat test at your choice of more than 4,500 conveniently located test sites in more than 165 countries worldwide.
                        </p>
                    </div>
    
                    <!-- More Program Sections -->
                    <div style="background-color: linear-gradient(180deg, #E8F2FC, #D9EAFB) ; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border-radius: 8px; padding: 2rem;">
                        <h3 style="font-weight: bold; margin-bottom: 1.5rem; font-size: 1.25rem;">QUANTATIIVE SECTION</h3>
                        <p style="line-height: 1.6; margin-bottom: 1.5rem; font-size: 0.95rem; color: #333;">
                            GMAT tests all four language skills – listening, reading, writing, and speaking. The Speaking test is a face-to-face interview with a certified Examiner. It is interactive and as close to a real-life situation as a test can get.
                        </p>
                    </div>
    
                    <div style="background-color: linear-gradient(180deg, #E8F2FC, #D9EAFB) ; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border-radius: 8px; padding: 2rem;">
                        <h3 style="font-weight: bold; margin-bottom: 1.5rem; font-size: 1.25rem;">VERBAL SECTION</h3>
                        <p style="line-height: 1.6; margin-bottom: 1.5rem; font-size: 0.95rem; color: #333;">
                            GMAT tests all four language skills – listening, reading, writing, and speaking. The Speaking test is a face-to-face interview with a certified Examiner. It is interactive and as close to a real-life situation as a test can get.
                        </p>
                    </div>
